<template>
  <span>  
    <modal name="form-codigo" height="auto" :width="300" :scrollable="true" :clickToClose="false">
      <div class="box box-solid">
        <div class="box-header">
          ...
          <p class="login-box-msg" style="padding-bottom:0px;">Filtrar Código</p>
        </div>
        <div class="box-body">
          <div class="form-group">
            <label>Ingrese código de salida:</label>
